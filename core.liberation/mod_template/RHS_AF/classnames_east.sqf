...
opfor_recyclable = [
	...
	["LOP_ChDKZ_BM21",1,round (20 / GRLIB_recycling_percentage),2],
	["LOP_ChDKZ_UAZ_AGS",1,round (40 / GRLIB_recycling_percentage),2],
	["LOP_ChDKZ_UAZ_DshKM",1,round (30 / GRLIB_recycling_percentage),2],
	["LOP_ChDKZ_UAZ_SPG",1,round (40 / GRLIB_recycling_percentage),2],
	...
	["rhs_t90a_tv",10,round (150 / GRLIB_recycling_percentage),10],
	...
	["rhs_mi28n_vvsc",10,round (150 / GRLIB_recycling_percentage),10],

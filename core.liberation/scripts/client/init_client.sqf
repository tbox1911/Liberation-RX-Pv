...
[] call compileFinal preprocessFileLineNUmbers "scripts\client\init_client_classmap.sqf";
...
get_myBeacons = compileFinal preprocessFileLineNumbers "scripts\client\misc\get_mybeacons.sqf";
